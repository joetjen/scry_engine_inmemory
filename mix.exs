defmodule Scry.Engine.InMemory.MixProject do
  ...
  defp description do
    "A real, kind-independent Scry.Core.EngineBehaviour implementation over a plain " <>
      "in-memory Elixir term store -- no query pushdown, the deliberately-unoptimized " <>
      "baseline every scry_test_<kind> package uses for its own default fixture."
  end

  defp package do
    [
      licenses: ["MIT"],
      links: %{"GitHub" => "https://github.com/joetjen/scry_engine_inmemory"},
  ...
  defp docs do
    [
      main: "readme",
      source_url: "https://github.com/joetjen/scry_engine_inmemory",
